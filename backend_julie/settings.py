"""
Django settings for backend_julie project.
...
SECRET_KEY = 'django-insecure-f$ii3sfa7dpeb8_wyfy%nv!*513_6g@nep--o1*@o(0+2yw=_$'
...
WSGI_APPLICATION = 'backend_julie.wsgi.application'
